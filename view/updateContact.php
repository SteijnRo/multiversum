    ...
    <form action="?op=updateContact" method="post">
      ...
      <ul class="list-unstyled opening-hours">
        ...
        for ($i=0; $i < count($content['businesshours']); $i++) { 
          echo "
            <li>". $content['businesshours'][$i]['weekDay'] ." <span class=\"pull-right\"><input type='text' name='($i*)openH' value='" . $content['businesshours'][$i]['openH'] . "'> - <input type='text' name='($i*)closeH' value='" . $content['businesshours'][$i]['closeH'] . "'> </span></li>
          ";
        }
        ?>
      </ul>
